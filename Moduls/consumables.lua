...
--       CONSUMABLES      --
----------------------------
table.insert(consumables, addon:newSpell("Flasks", {17626, 17627, 17628, 17629}, {"TANK", "MELEE", "RANGE"}))
table.insert(consumables, addon:newSpell("Magic Protection Potion", {17543, 17549, 17544, 17546, 17548}, {"TANK", "MELEE", "RANGE"}))
...
function addon:getConsumables(role)
    local tmp = {}
