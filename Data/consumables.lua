...
table.insert(consumables, addon:new_Group("Flask", addon:spell_Remap(flask), {"tank", "physical", "caster"}))
...
table.insert(consumables, addon:new_Group("Magic Protection Potion", addon:spell_Remap(potion), p_roles))
...
table.insert(consumables, addon:new_Group("Defense Elixirs", addon:spell_Remap(defense), d_roles))
...
table.insert(consumables, addon:new_Group("Physical Elixirs", addon:spell_Remap(physical), p_roles))
...
table.insert(consumables, addon:new_Group("Caster Elixirs", addon:spell_Remap(caster), c_roles))
